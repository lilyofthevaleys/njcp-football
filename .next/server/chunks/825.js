...
function createSlot(ownerName) {
    ...
    const Slot2 = /*#__PURE__*/ react_shared_subset.forwardRef((props, forwardedRef)=>{
        ...
        if (slottable) {
            ...
            const newChildren = childrenArray.map((child)=>{
                if (child === slottable) {
                    ...
                    return /*#__PURE__*/ react_shared_subset.isValidElement(newElement) ? newElement.props.children : null;
                } else {
                    return child;
                }
            });
            return /* @__PURE__ */ (0,jsx_runtime_.jsx)(SlotClone, {
                ...slotProps,
                ref: forwardedRef,
                children: /*#__PURE__*/ react_shared_subset.isValidElement(newElement) ? /*#__PURE__*/ react_shared_subset.cloneElement(newElement, void 0, newChildren) : null
            });
        }
        return /* @__PURE__ */ (0,jsx_runtime_.jsx)(SlotClone, {
            ...slotProps,
...
function createSlotClone(ownerName) {
    const SlotClone = /*#__PURE__*/ react_shared_subset.forwardRef((props, forwardedRef)=>{
        const { children, ...slotProps } = props;
        if (/*#__PURE__*/ react_shared_subset.isValidElement(children)) {
            const childrenRef = getElementRef(children);
            const props2 = mergeProps(slotProps, children.props);
            if (children.type !== react_shared_subset.Fragment) {
                props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
            }
            return /*#__PURE__*/ react_shared_subset.cloneElement(children, props2);
        }
...
function isSlottable(child) {
    return /*#__PURE__*/ react_shared_subset.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER;
}
...
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5182);
/**
